...
import { openDb, float32ToBuffer } from "./db.js";
import { EMBEDDING_MODEL } from "./constants.js";
import { embedBatch } from "./embed.js";
import { chunkText, extractText, sha256 } from "./chunking.js";
import { IndexMeta } from "./db.js";
...
export async function indexFiles(
  ...
  try {
    ...
    const flushGroup = async () => {
      ...
      // Yield so the TUI can render the progress update.
      await yield_();
    };
